def bigquant_run(bq_graph, inputs):
    ...
    parameters_list = []
    for num in list:
        expr = 'volume_0/volume_1>1.7&turn_0==max_turn&ac0==max_ac&sma_close_5>sma_close_10&sma_close_5>sma_close_20&sma_volume_5>sma_volume_10&open_0<close_0&mf_net_pct_main_0<0.4&sum_mf>0.1&rank_return_0>0.9&rank_return_5>0.9' \
               '&rank_avg_mf_net_amount_5<'
        tmp = expr + str(num)
        parameters = {'m10.expr': tmp}
