def bigquant_run(bq_graph, inputs):
    ...
    factor_pool = ['return_0>1.03',
                   ...
                   "sum_main_30>11",
                   "fs_roa_ttm_0>5",
                   "close_0>ts_max_close_56",
                   "mf_net_amount_0>mf_net_amount_1",
                   "mf_net_amount_xl_0>mean_xl_30",
                   "cond4>0.05",
                   "cond5>1.25",
                   "cond6>1.16",
                   "cond28>5",
                   ...
                   "cond17==1",
                   "cond18==1",
                   "(volume_2/volume_1<2.5)|(high_0/close_0 <1.05)&(volume_2/volume_0>1)",
                   "(open_0/high_0<1)&(high_0/close_0<1.03)",
                   "(open_0/high_0<0.97)&(high_0/close_0<1.04)",
                   "close_0>open_0",
                   "some321==1",
                   "some456==1",
                   "cond30>0.1",
